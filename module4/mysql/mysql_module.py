...
if __name__ == "__main__":
    test_mysql0 = MySql("localhost",3306,"root","root")
    test_mysql1 = MySql("localhost",3306,"root","root","test")

    sql1 = "show databases;"
    sql2 = "show tables;"
    sql3 = "select * from test.student where ID<0;"
    sql4 = "insert into test.student VALUES (19,%s,'English',%s);"

    res = test_mysql1.exec_sql(sql4,"yangxhadfasdaga",101)
